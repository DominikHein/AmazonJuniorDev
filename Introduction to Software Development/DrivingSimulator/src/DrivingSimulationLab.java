...
public class DrivingSimulationLab {
    ...
    public static void toggleEngine() {
        ...
        if(isEngineOn == false){
            //If engine is turned off, turn on engine
            isEngineOn = true;
            return;
        }else{
            //If engine is turned on, turn off engine
            isEngineOn = false;
            return;
        }
    }
    ...
    public static void brake() {
        ...
        if (isEngineOn && speed > 5) {
            ...
            System.out.println("Braking was not possible");
        }
    }
    ...
    public static void exitSimulation() {
        ...
        System.out.println("You're exiting the simulation. Goodbye");
