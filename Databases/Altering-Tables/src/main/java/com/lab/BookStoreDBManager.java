...
public class BookStoreDBManager {
    ...
    // Adding a New Column to Store Genre
    ...
    // Modifying the Precision of the Price Column
    ...
    // Adding a Published Date Column
    public static void addPublishedDateColumn(Connection conn) {
        try {
            ...
            String insertBookSQL = "INSERT INTO books (title, author, price, genre, published_date) VALUES " +
                                    "('The Great Gatsby', 'F. Scott Fitzgerald', 10.99, 'Crime','1925-04-10');";
